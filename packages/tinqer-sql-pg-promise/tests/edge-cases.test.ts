...
describe("Edge Cases and Error Handling", () => {
  ...
  describe("Empty queries", () => {
    it("should handle simple FROM without any operations", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test_table")), {});
  ...
  describe("Special characters and identifiers", () => {
    it("should handle table names with underscores", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("user_accounts_table")), {});

      expect(result.sql).to.equal('SELECT * FROM "user_accounts_table"');
    });

    it("should handle table names with numbers", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("table123")), {});
  ...
  describe("Extreme values", () => {
    ...
    it("should handle zero values", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").where((t) => t.value == 0)), {});
  ...
  describe("String edge cases", () => {
    it("should handle empty strings", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").where((t) => t.name == "")), {});
  ...
  describe("Boolean edge cases", () => {
    ...
    it("should handle boolean field directly", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").where((t) => t.flag)), {});
  ...
  describe("Pagination edge cases", () => {
    it("should handle SKIP 0", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").skip(0)), {});
    ...
    it("should handle TAKE 0", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").take(0)), {});
    ...
    it("should handle very large SKIP", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").skip(1000000)), {});
    ...
    it("should handle very large TAKE", () => {
      const result = toSql(defineSelect(schema, (q) => q.from("test").take(999999)), {});
