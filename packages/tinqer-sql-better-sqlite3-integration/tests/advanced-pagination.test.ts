 ...
 * Tests for various pagination strategies and patterns with real Better SQLite3.
 */
...
describe("Better SQLite3 Integration - Advanced Pagination", () => {
  ...
  describe("Offset-based pagination", () => {
    it("should paginate with skip and take", () => {
      const page = 2;
      const pageSize = 3;
    ...
    it("should paginate with dynamic page size", () => {
      const pageSize = 5;
      const pageNumber = 2;
    ...
    it("should handle first page (no skip)", () => {
      const pageSize = 4;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
  ...
  describe("Cursor-based pagination patterns", () => {
    it("should paginate using ID cursor", () => {
      const lastId = 3;
      const pageSize = 3;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
    ...
    it("should paginate backwards using ID cursor", () => {
      const firstId = 7;
      const pageSize = 3;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
    ...
    it("should use composite cursor (date + id)", () => {
  ...
  describe("Keyset pagination", () => {
    it("should use single column keyset", () => {
    ...
    it("should use multi-column keyset", () => {
  ...
  describe("Pagination with aggregates", () => {
    ...
    it("should paginate with HAVING clause", () => {
      const minCount = 2;
      const pageSize = 2;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
  ...
  describe("Pagination with JOIN", () => {
    it("should paginate joined results", () => {
      const page = 2;
      const pageSize = 3;
      const offset = (page - 1) * pageSize;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
  ...
  describe("Pagination with DISTINCT", () => {
    it("should paginate distinct results", () => {
      const pageSize = 2;
      const offset = 1;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
  ...
  describe("Dynamic pagination", () => {
    it("should handle variable page sizes", () => {
  ...
  describe("Performance-optimized pagination", () => {
    it("should use covering index pattern", () => {
      const page = 2;
      const pageSize = 3;
      const offset = (page - 1) * pageSize;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
    ...
    it("should avoid large offsets with cursor", () => {
  ...
  describe("Complex pagination scenarios", () => {
    it("should paginate with complex WHERE conditions", () => {
      const minPrice = 50;
      const maxPrice = 500;
      const category = "Electronics";
    ...
    it("should handle pagination with multiple sorting criteria", () => {
      const pageSize = 3;
      let capturedSql: { sql: string; params: Record<string, unknown> } | undefined;
      ...
      if (results[0] && results[0].is_featured) {
        expect(results[0].is_featured).to.equal(1);
      }
    });

    it("should paginate search results with relevance", () => {
