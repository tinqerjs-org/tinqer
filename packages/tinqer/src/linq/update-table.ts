 ...
 */
export function updateTable<T>(tableName: string): Updatable<T>;
 ...
 */
export function updateTable<TSchema, K extends keyof TSchema & string>(
  context: DatabaseContext<TSchema>,
  tableName: K,
): Updatable<TSchema[K]>;

// Implementation
export function updateTable(_contextOrTable: unknown, _tableName?: unknown): Updatable<unknown> {
